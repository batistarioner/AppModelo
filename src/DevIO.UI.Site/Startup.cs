...
namespace DevIO.UI.Site
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      //services.AddScoped<IPedidoRepository, PedidoRepository>();    // A cada riquest cria uma nova instacia 
      //services.AddSingleton<IPedidoRepository, PedidoRepository>(); // Cria uma unica instancia
    }
